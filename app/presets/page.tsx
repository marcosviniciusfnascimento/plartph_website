...
export default function PresetsPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-zinc-100 to-[#9F9183] flex min-h-screen flex-col items-center justify-start w-full">
      <Reveal width="100%">
        <div className="flex flex-col space-y-3 items-center justify-start pt-24 text-center max-sm:px-10">
          ...
          <span className="pt-10 pb-2 font-theseasons text-6xl text-zinc-800 max-sm:text-5xl">
            Wood Mood
          </span>
      ...
      <Reveal width="100%">
        <div className="w-screen bg-primary items-center justify-center flex mt-10 p-10 max-sm:p-0">
      ...
      <Reveal width="100%">
        <div className="bg-stone-500/70 flex flex-col space-y-3 items-center justify-center pt-16 max-sm:px-10">
        ...
        <div className="bg-stone-500/70 flex flex-col space-y-3 w-full items-center justify-center pb-20 max-sm:px-10">
          <span className="flex pt-20 pb-10 max-sm:pt-10">
      ...
      <Reveal width="100%">
        <div className="flex space-x-5 py-20 bg-zinc-100 px-20 max-sm:px-10 items-center justify-center w-full flex-row max-sm:flex-col">
          <span className="flex flex-col space-y-10 font-Geosans text-gray-500 text-5xl w-5/12 max-sm:text-3xl max-sm:w-full">
            <h5>
      ...
      <Reveal width="100%">
        <div className="bg-zinc-100 flex space-x-2 items-center justify-center w-full py-20 px-20 flex-row max-sm:flex-col max-sm:px-10">
          <div className="flex flex-col items-center justify-center space-y-5 w-4/12 max-sm:w-full">
            <span className="font-Geosans text-zinc-800 text-3xl flex flex-col space-y-2 items-center justify-center text-center">
              <h5>O que você vai receber também?</h5>
              <div className="h-[1px] w-9/12 bg-zinc-800" />
            </span>
            <span className="font-theseasons text-zinc-800 text-xl flex space-x-2 items-center justify-center text-center">
          ...
          <div className="w-4/12 flex items-center justify-center h-full max-sm:w-full max-sm:mt-20">
            <Image
              src={bannerVenda}
              alt="bannerVenda"
      ...
      <Reveal width="100%">
        <div className="w-full flex items-center justify-center bg-[#BB987D] space-x-5 p-20 max-sm:flex-col flex-row max-sm:px-10">
          ...
          <div className="flex flex-col space-y-5 w-1/2 max-sm:w-full max-sm:pt-10">
            <span className="text-zinc-800 text-left">
